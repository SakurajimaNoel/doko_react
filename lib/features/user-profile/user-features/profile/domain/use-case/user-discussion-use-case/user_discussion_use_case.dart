...
class UserDiscussionUseCase extends UseCases<bool, UserProfileNodesInput> {
  UserDiscussionUseCase({required this.profileRepository});

  final ProfileRepository profileRepository;

  @override
  FutureOr<bool> call(UserProfileNodesInput params) async {
    return profileRepository.getUserDiscussions(params);
  }
}
