...
class CommentsWithRepliesUseCase implements UseCases<bool, GetNodeInput> {
  const CommentsWithRepliesUseCase({
  ...
  FutureOr<bool> call(GetNodeInput params) {
    return rootNodeRepository.getCommentWithReplies(params);
  }
}
