...
class AuthenticationActions {
  static Future<AuthenticationResult> signInUser(String email,
  ...
  static Future<AuthenticationResult> signUpUser(String email,
      String password) async {
    try {
  ...
  static Future<AuthenticationResult> confirmResetPassword(String email,
  ...
  static AuthenticationResult _handleSignInResult(SignInResult result,
      String username) {
  ...
  static Future<AuthenticationToken> getAccessToken() async {
    try {
      ...
      return AuthenticationToken(
          status: AuthStatus.error, value: e.message);
    } catch (e) {
      safePrint(e);
      return AuthenticationToken(
