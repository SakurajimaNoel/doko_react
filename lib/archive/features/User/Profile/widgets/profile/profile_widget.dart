...
import 'package:doko_react/archive/features/User/data/graphql_queries/friend_relation.dart';
import 'package:doko_react/archive/features/User/data/graphql_queries/query_constants.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Query(
      ...
      builder: (QueryResult result, {Refetch? refetch, FetchMore? fetchMore}) {
        ...
        if (self) userProvider.updateUser(result.data);
