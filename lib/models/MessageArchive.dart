...
class MessageArchive extends amplify_core.Model {
  ...
  MessageArchiveModelIdentifier get modelIdentifier {
    try {
      return MessageArchiveModelIdentifier(archive: _archive!, id: id);
    } catch (e) {
  ...
  const MessageArchive._internal(
      {required this.id,
      required archive,
      required from,
      required to,
  ...
  String toString() {
    ...
    buffer.write(
        "edited=" + (_edited != null ? _edited.toString() : "null") + ", ");
    buffer.write(
        "deleted=" + (_deleted != null ? _deleted.toString() : "null") + ", ");
    buffer.write("forwarded=" +
        (_forwarded != null ? _forwarded.toString() : "null") +
        ", ");
  ...
  static final amplify_core.QueryModelIdentifier<MessageArchiveModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<MessageArchiveModelIdentifier>();
 ...
 */
class MessageArchiveModelIdentifier
    implements amplify_core.ModelIdentifier<MessageArchive> {
  ...
  const MessageArchiveModelIdentifier(
      {required this.archive, required this.id});

  @override
  Map<String, dynamic> serializeAsMap() =>
      (<String, dynamic>{'archive': archive, 'id': id});
  ...
  @override
  String toString() =>
      'MessageArchiveModelIdentifier(archive: $archive, id: $id)';
  ...
  @override
  int get hashCode => archive.hashCode ^ id.hashCode;
}
