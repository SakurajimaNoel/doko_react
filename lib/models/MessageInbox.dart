...
class MessageInbox extends amplify_core.Model {
  ...
  MessageInboxModelIdentifier get modelIdentifier {
    try {
      return MessageInboxModelIdentifier(user: _user!, inboxUser: _inboxUser!);
    } catch (e) {
  ...
  const MessageInbox._internal(
      {required user, required inboxUser, displayText, createdAt, updatedAt})
      : _user = user,
  ...
  factory MessageInbox(
      {required String user, required String inboxUser, String? displayText}) {
    return MessageInbox._internal(
        user: user, inboxUser: inboxUser, displayText: displayText);
  }
  ...
  MessageInbox copyWith({String? displayText}) {
    return MessageInbox._internal(
        user: user,
        inboxUser: inboxUser,
  ...
  MessageInbox copyWithModelFieldValues(
    ...
    return MessageInbox._internal(
        ...
        inboxUser: inboxUser,
        displayText:
            displayText == null ? this.displayText : displayText.value);
  }
  ...
  static final amplify_core.QueryModelIdentifier<MessageInboxModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<MessageInboxModelIdentifier>();
 ...
 */
class MessageInboxModelIdentifier
    implements amplify_core.ModelIdentifier<MessageInbox> {
  final String user;
  ...
  const MessageInboxModelIdentifier(
      {required this.user, required this.inboxUser});

  @override
  Map<String, dynamic> serializeAsMap() =>
      (<String, dynamic>{'user': user, 'inboxUser': inboxUser});
  ...
  @override
  String toString() =>
      'MessageInboxModelIdentifier(user: $user, inboxUser: $inboxUser)';
  ...
  @override
  int get hashCode => user.hashCode ^ inboxUser.hashCode;
}
